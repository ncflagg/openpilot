// global torque limit
const int TOYOTA_MAX_TORQUE = 2200;       // max torque cmd allowed ever

// rate based torque limit + stay within actually applied
// packet is sent at 100hz, so this limit is 1000/sec
const int TOYOTA_MAX_RATE_UP = 20;        // ramp up slow
const int TOYOTA_MAX_RATE_DOWN = 20;      // ramp down fast
const int TOYOTA_MAX_TORQUE_ERROR = 1000;  // max torque cmd in excess of torque motor

// real time torque limit to prevent controls spamming
// the real time limit is 1500/sec
const int TOYOTA_MAX_RT_DELTA = 1000; //375;      // max delta torque allowed for real time checks
