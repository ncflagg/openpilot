...
const int TOYOTA_MAX_TORQUE_ERROR = 550;  // max torque cmd in excess of torque motor

// real time torque limit to prevent controls spamming
// the real time limit is 1500/sec
const int TOYOTA_MAX_RT_DELTA = 575;      // max delta torque allowed for real time checks
