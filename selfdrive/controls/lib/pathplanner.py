...
class PathPlanner(object):
  ...
  def update(self, sm, CP, VM):
    ...
    self.cur_state = calc_states_after_delay(self.cur_state, v_ego, angle_steers - (1.5 * sm['liveParameters'].angleOffset), curvature_factor, VM.sR, CP.steerActuatorDelay)
