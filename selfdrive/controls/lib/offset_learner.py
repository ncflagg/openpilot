...
class OffsetLearner:
    def __init__(self, debug=False):
        ...
        # Tunables
        self.learning_rate = 400         #   10 @20Hz. Could've been a hair faster, maybe
        self.slow_learning_rate = 12000  # 2400 @20Hz. Z was 12000 for slow curvature and said 100Hz
    ...
    def update(self, angle_steers=0., d_poly=None, v_ego=0.):
        ...
        if angle_steers > 0.1  and  15.6 < v_ego < 24.6:  # 35-55mph
        ...
        self.frame_print += 1
        if self.frame_print >= 100:  # every second, at 100Hz
