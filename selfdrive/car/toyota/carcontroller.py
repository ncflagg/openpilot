...
class SteerLimitParams:
  STEER_MAX = 1750
  STEER_DELTA_UP = 12 #17.5       # 1.5s time to peak torque
  STEER_DELTA_DOWN = 12 #5 #18     # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
...
class CustomSteerLimitParams:
  ...
  STEER_DELTA_DOWN = 12     # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
  STEER_ERROR_MAX = 1000     # max delta between torque cmd and torque motor
