...
class CarInterface(object):
  ...
  def get_params(candidate, fingerprint, vin="", is_panda_black=False):
    ...
    if candidate == CAR.PRIUS:  # PRIME
      ...
      tire_stiffness_factor = 17.75 #0.089  # Needs some corner testing, but somewhere 16-20 for Prime
      ...
      ret.steerActuatorDelay = 0.75 #0.18  #0.19 / 0.2 seemed too big; turning late  #1.0 # disabled
