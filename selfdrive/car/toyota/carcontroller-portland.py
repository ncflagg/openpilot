...
class SteerLimitParams:
  STEER_MAX = 1500
  STEER_DELTA_UP = 17 #16 #17.5       # 1.5s time to peak torque
  STEER_DELTA_DOWN = 17 #15 #18     # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
  STEER_ERROR_MAX = 550     # max delta between torque cmd and torque motor

# Custom steer torque limits
class CustomSteerLimitParams:
  STEER_MAX = 1500
  STEER_DELTA_UP = 15 #12       # 1.5s time to peak torque
  STEER_DELTA_DOWN = 15.5 #12     # always lower than 45 otherwise the Rav4 faults (Prius seems ok with 50)
  STEER_ERROR_MAX = 550     # max delta between torque cmd and torque motor
